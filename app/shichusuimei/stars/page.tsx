      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#EAE4DC]">
            {stems.map((s) => (
              <div key={s.stem} className="bg-[#F5F1EA] p-6 flex gap-6">
                ...
                <div>
                  <p className="text-xs text-[#8B5E3C] tracking-wider mb-2">{s.element}</p>
                  <p className="text-sm text-[#3D3630] leading-loose tracking-wider">{s.nature}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="mb-12">
          <div className="flex items-center gap-6 mb-10">
            ...
            <span className="font-display italic text-[#C4926A] text-sm">ten stars</span>
            <div className="flex-1 h-px bg-[#EAE4DC]" />
          </div>
          <h2 className="font-display text-4xl font-light mb-2">通変星（十神）</h2>
          <p className="text-sm text-[#8A7E75] mb-8 tracking-wider">
              ...
              <div key={star.name} className="bg-[#F5F1EA] p-8">
                <div className="grid grid-cols-1 md:grid-cols-[140px_1fr] gap-6">
                  <div>
                    ...
                    <p className="text-xs text-[#8A7E75] tracking-wider mb-1">{star.en}</p>
                    <span className="inline-block text-xs border border-[#D6C5B0] text-[#8A7E75] px-2 py-0.5 tracking-wider">
                      {star.category}
                    </span>
                  </div>
                  <div>
                    <p className="text-xs text-[#8B5E3C] tracking-wider mb-3">{star.keyword}</p>
                    <p className="text-sm text-[#3D3630] leading-loose tracking-wider">{star.desc}</p>
                  </div>
                </div>
              </div>
            ))}
