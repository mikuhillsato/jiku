    ...
    <>
      ...
      <div className="border-b border-[#1A1F35]">
        <div className="max-w-6xl mx-auto px-6 py-20">
          <AnimateIn>
            <p className="text-xs tracking-[0.3em] text-[#8888AA] mb-4 uppercase">About</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            <AnimateIn>
              <p className="font-display italic text-[#B8AEED] text-lg mb-4">concept</p>
            ...
            <AnimateIn delay={150}>
              <div className="space-y-px bg-[#1A1F35]">
                {[
                  ...
                  <div key={item.q} className="bg-[#0E1020] p-6">
                    <p className="text-xs text-[#8B7FCC] tracking-wider mb-2">Q. {item.q}</p>
                    <p className="text-sm text-[#C0BDD4] leading-loose tracking-wider">A. {item.a}</p>
                  </div>
                ))}
              </div>
            </AnimateIn>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-6 mb-12">
            ...
            <span className="font-display italic text-[#B8AEED] text-sm">for whom</span>
            <div className="flex-1 h-px bg-[#1A1F35]" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#1A1F35]">
            {[
              ...
              <AnimateIn key={item.icon} delay={parseInt(item.icon) * 100}>
                <div className="bg-[#0E1020] p-8 h-full">
                  <span className="font-display text-4xl text-[#303860] font-light block mb-4">
                    {item.icon}
                  </span>
        ...
        <section>
          <AnimateIn>
            <div className="bg-[#0D1028] text-[#E8E5F5] p-12 md:p-16">
              <p className="font-display italic text-[#B8AEED] text-lg mb-6">vision</p>
              ...
              <p className="text-sm text-[#8888AA] leading-loose tracking-wider max-w-lg">
                まずは四つの占術を深く学び、自分という存在を解像度高く知ること。
                それが、すべての出発点になる。
              </p>
              <div className="mt-10 pt-10 border-t border-[#2A2520]">
                <p className="font-display italic text-[#B8AEED]">Know yourself. Design your life.</p>
              </div>
            </div>
          </AnimateIn>
        </section>
